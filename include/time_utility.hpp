...
std::chrono::duration<double, std::ratio<1, SRATE> >
duration_in_samples(D&& duration) noexcept
{
    return std::chrono::duration_cast<std::chrono::duration<double,
           std::ratio<1, SRATE> > >(std::forward < D && > (duration));
}
...
duration_in_samples(D&& duration, double sample_rate) noexcept
{
...
#endif // ifndef ZAUDIO_TIME_UTILITY
