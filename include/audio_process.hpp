...
/*!
  ...
  template<typename sample_t>
  void audio_process<sample_t>::on_error(const stream_error &err) noexcept
  {
      default_stream_error_callback()(err);
  }

  template<typename sample_t>
  typename audio_process<sample_t>::callback audio_process<sample_t>::get_callback() noexcept
  {
  ...
  template<typename sample_t>
  typename audio_process<sample_t>::error_callback audio_process<sample_t>::get_error_callback() noexcept
  {
      using std::placeholders::_1;
