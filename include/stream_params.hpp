...
public:
    constexpr
    stream_params() noexcept;

    constexpr
    stream_params(double sr,
      std::size_t        fc,
    ...
    constexpr const std::size_t&
    input_frame_width() const noexcept;

    constexpr const std::size_t&
    output_frame_width() const noexcept;

    constexpr const std::size_t
    input_sample_count() const noexcept;

    constexpr const std::size_t
    output_sample_count() const noexcept;

    constexpr const double&
    sample_rate() const noexcept;

    constexpr const double
    input_byte_rate() const noexcept;

    constexpr const double
    input_bit_rate() const noexcept;

    constexpr const double
    output_byte_rate() const noexcept;

    constexpr const double
    output_bit_rate() const noexcept;

    constexpr const long&
    input_device_id() const noexcept;

    constexpr const long&
    output_device_id() const noexcept;

    friend std::ostream&
    operator << (std::ostream& os, stream_params<sample_t>& params);
...
template <typename sample_t>
constexpr const std::size_t&
stream_params<sample_t>::frame_count() const noexcept
{
    return _frame_count;
}
...
template <typename sample_t>
constexpr const std::size_t&
stream_params<sample_t>::input_frame_width() const noexcept
{
...
template <typename sample_t>
constexpr const std::size_t&
stream_params<sample_t>::output_frame_width() const noexcept
{
...
template <typename sample_t>
constexpr const std::size_t
stream_params<sample_t>::input_sample_count() const noexcept
{
...
template <typename sample_t>
constexpr const std::size_t
stream_params<sample_t>::output_sample_count() const noexcept
{
...
template <typename sample_t>
constexpr const double&
stream_params<sample_t>::sample_rate() const noexcept
{
    return _sample_rate;
}
...
template <typename sample_t>
constexpr const double
stream_params<sample_t>::input_byte_rate() const noexcept
{
...
template <typename sample_t>
constexpr const double
stream_params<sample_t>::input_bit_rate() const noexcept
{
...
template <typename sample_t>
constexpr const double
stream_params<sample_t>::output_byte_rate() const noexcept
{
...
template <typename sample_t>
constexpr const double
stream_params<sample_t>::output_bit_rate() const noexcept
{
...
template <typename sample_t>
constexpr const long&
stream_params<sample_t>::input_device_id() const noexcept
{
...
template <typename sample_t>
constexpr const long&
stream_params<sample_t>::output_device_id() const noexcept
{
...
constexpr stream_params<typename std::decay<sample_t>::type>
make_stream_params(args_t&& ... args) noexcept
{
    return stream_params<typename std::decay<sample_t>::type>(std::forward < args_t && > (args) ...);
}
}

#endif // ifndef ZAUDIO_STREAM_PARAMS
